...
public class HelloHttpFunction implements HttpFunction {
    ...
    public JsonArray searchToys(String searchText, HikariDataSource dataSource) throws Exception {
        ...
        System.out.println("\n\n\n\n\n\n\n*********************** END SEARCH TEXT ***********************");
        String query = " SELECT  id,name, content, quantity, price, image_url, recommended_text, "
                ...
                + "      FROM toys ORDER BY text_embeddings <=> embedding('text-embedding-005',  '" + searchText
                + "')::vector "
